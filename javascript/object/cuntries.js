var countries=[
  ...
  for(let country of countries){
    ...
    // co.population=populations
    let currencyName="NA"
    if( "currencies" in country){
      currencyName=country.currencies[0].name
    }
    // co.currency=currencyName
    let countryData={countryName,populations,currencyName,capitals}
    result.push(countryData)
    // console.log(`COUNTRY :${countryName} capital : ${capital} population :${population} currency : ${currencyName}`)
  }
  // console.log(result);
  ...
  // print country names
// result.forEach(name=>console.log(name.countryName))

  // print details of india
  // let ind=result.find(name=>name.countryName=="India")
  // console.log(ind);

  // print chinese currency
  // let chinacurrency=result.find(n1=>n1.countryName=="China").currencyName
  // console.log(chinacurrency);

  result.filter(pop=>pop.populations>20000000).map(cntry=>cntry.countryName).forEach(names=>console.log(names))
